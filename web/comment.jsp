...
<html>
  ...
  <div class="container">
    ...
    <br/><br/>
    <form method="post" name="frm" action="comment">
      <table border="0" width="300" align="center" bgcolor="pink">
        ...
        <tr><td valign="top"><font size="5">Comment: </td>
                    <td><textarea rows="7" cols="50" name ="comment" placeholder="What is your feedback?" id="comment" required></textarea> </td>
                </tr>    
