...
<div class="panel-body">
    <form role="form" method="post" id="payment-form" action="donate">
<div class="row">
<div class="col-xs-12">
...
<div class="col-xs-12">
<div class="form-group">
<label for="couponCode">Project Name</label>
<input type="text" class="form-control" placeholder="Project's Name" name="projectName" id="projectName" />
</div>
</div>                        
</div>
<div class="row">
<div class="col-xs-12">
<div class="form-group">
<label for="couponCode">AMOUNT (RM)</label>
<input type="text" class="form-control" placeholder="Amount" name="currentFund" id="currentFund" />
</div>
</div>                        
</div>
<div class="row">
