				...
				<div class="content col-md-8 col-sm-12 col-xs-12">
					<div class="section-block">
						<div class="funding-meta">
							<h1>document.write(pList.get(0))</h1>
							<span class="type-meta"><i class="fa fa-user"></i> document.write(pList.get(1))</span>
							...
							<p>document.write(pList.get(3))</p>
							<h2>document.write(pList.get(2))</h2>							
